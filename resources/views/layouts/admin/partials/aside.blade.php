<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 "
    ...
    <div class="collapse navbar-collapse  w-auto h-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ request()->routeIs('admin.ruang') ? 'active' : '' }}"
            ...
            <a class="nav-link {{ request()->routeIs('admin.pengaduan') ? 'active' : '' }}  "
                ...
                {{-- gunakan fontawensome 5 --}}
                {{-- agar warna berubah gunakan class aside-box dan hapus bg-white --}}
                <div
                    ...
                    {{-- agar warna icons berubah juga gunakan aside-icons --}}
